...
import { BigInt, Address, store, ethereum, Bytes } from "@graphprotocol/graph-ts";
...
export function createLiquidityPool(event: ethereum.Event, poolAddress: Bytes, token0Address: Bytes, token1Address: Bytes): void {
