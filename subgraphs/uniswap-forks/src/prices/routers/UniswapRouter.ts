...
import { UniswapPair as UniswapPairContract, UniswapPair__getReservesResult } from "../../../generated/Factory/UniswapPair";
...
export function getLpTokenTotalLiquidityUsdc(tokenAddress: Address, network: string): CustomPriceType {
  ...
  let reserves = utils.readValue<UniswapPair__getReservesResult>(uniSwapPair.try_getReserves(), constants.UNISWAP_DEFAULT_RESERVE_CALL);
